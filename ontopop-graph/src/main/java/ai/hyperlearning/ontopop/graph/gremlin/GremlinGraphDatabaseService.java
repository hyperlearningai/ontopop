...
public class GremlinGraphDatabaseService implements GraphDatabaseService {
    ...
    private static final String PROPERTY_KEY_ONTOLOGY_LABEL = "label";
    ...
    @Override
    public GraphTraversal<Vertex, Vertex> getVertices(String propertyKey,
    ...
    @Override
    public Vertex getVertex(String label, String propertyKey,
            Object propertyValue) {
        ...
        if (!vertices.isEmpty()) {
            ...
            for (List<SimpleGraphVertex> verticesSubList : verticesSubLists) {
                ...
                for (SimpleGraphVertex vertex : verticesSubList) {
                    ...
                    for (Map.Entry<String, Object> entry : vertex
        ...
        if (!propertyMaps.isEmpty()) {
            ...
            for (List<Map<String, Object>> propertyMapsSubList : propertyMapsSubLists) {
                ...
                for (Map<String, Object> vertexPropertyMap : propertyMapsSubList) {
                    if (counter > 0)
                        graphTraversal.addV(label);
                    for (Map.Entry<String, Object> entry : vertexPropertyMap
                            .entrySet()) {
                        String key = entry.getKey()
                                .equalsIgnoreCase(PROPERTY_KEY_ONTOLOGY_LABEL)
                                        ? PROPERTY_KEY_ONTOLOGY_LABEL_REPLACEMENT
    ...
    @Override
    public Vertex updateVertex(long vertexId, String propertyKey,
    ...
    @Override
    public GraphTraversal<Edge, Edge> getEdges(String label, String propertyKey,
            Object propertyValue) {
        return g.E().has(label, propertyKey, propertyValue);
    }

    @Override
    public GraphTraversal<Edge, Edge> getEdges(String propertyKey,
            Object propertyValue) {
    ...
    @Override
    public Edge getEdge(String label, String propertyKey,
            Object propertyValue) {
    ...
    @Override
    public Edge updateEdge(long edgeId, String propertyKey,
            Object propertyValue) throws NoSuchElementException {
    ...
    public List<Object> query(String gremlinQuery)
        ...
        CompletableFuture<Object> evalResult =
                gremlinExecutor.eval(gremlinQuery);
