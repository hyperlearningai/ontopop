...
public class DCMI {
    ...
    /**
     * Parse the DCMI RDF schema and generate a map of Annotation Property IRI
     * to OntoPop Simple Annotation Property objects
     * 
     * @param dcmiRdfSchema
     * @return
     */
    ...
    public static Map<String, SimpleAnnotationProperty> parseAnnotationProperties() {
        ...
        SimpleAnnotationProperty dcmiElementDescription =
                new SimpleAnnotationProperty(DC_ELEMENTS_DESCRIPTION_IRI,
                        DC_ELEMENTS_DESCRIPTION_IRI_LABEL,
                        new LinkedHashMap<>());
        simpleAnnotationPropertyMap.put(DC_ELEMENTS_DESCRIPTION_IRI,
                dcmiElementDescription);
