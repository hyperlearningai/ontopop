...
public class HashicorpVaultSecretsService {
    ...
    /**
     * Get a value given a path (e.g. ontopop/development) and key (e.g.
    ...
    public static Object get(VaultTemplate vaultTemplate, String mountPath,
        ...
        VaultResponse response = vaultTemplate
                .opsForKeyValue(mountPath, KV_BACKEND_VERSION).get(path);
        return response.getData().get(key);

    }

    /**
     * Get an object given a path (e.g. ontology/development/ontology/1) and
     * class type
     * 
     * @param <T>
     * @param path
    ...
    public static <T> VaultResponseSupport<T> get(VaultTemplate vaultTemplate,
        ...
        return vaultTemplate.opsForKeyValue(mountPath, KV_BACKEND_VERSION)
                .get(path, className);

    }

    /**
     * PUT an object given a path (e.g. ontology/development/ontology/1). Note
     * that PUT deletes all existing secrets at the given path before creating
     * the new secret.
     * 
     * @param path
     * @param object
    ...
    /**
     * Delete all secrets at a given path (e.g.
     * ontology/development/ontology/1).
     * 
     * @param vaultTemplate
     * @param mountPath
     * @param path
