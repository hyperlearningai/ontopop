...
/**
 * JanusGraph Gremlin Server HTTP Web Client Bean
 *
 * @author jillurquddus
 * @since 2.0.0
 */
...
public class JanusGraphGremlinServerHttpWebClientConfig {
    ...
    @Bean("janusGraphGremlinServerHttpWebClient")
    public WebClient getJanusGraphGremlinServerHttpWebClient() {
