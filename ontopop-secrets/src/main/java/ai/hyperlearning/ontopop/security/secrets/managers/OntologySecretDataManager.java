...
public class OntologySecretDataManager {
    ...
    public void put(OntologySecretData ontologySecretData) throws Exception {
        ...
        if (useVault) {
            HashicorpVaultSecretsService.put(vaultTemplate,
                    ...
                    springCloudVaultKvDefaultContext + vaultSubpathOntologies
        ...
        // Platform-specific secrets manager
            ...
            secretsService.set(
                    ONTOLOGY_SECRET_REPO_TOKEN_KEY + ontologySecretData.getId(),
                    ontologySecretData.getRepoToken());
            secretsService.set(
                    ONTOLOGY_SECRET_REPO_WEBHOOK_SECRET_KEY
                            + ontologySecretData.getId(),
    ...
    public OntologySecretData get(int ontologyId) throws Exception {
        ...
        if (useVault) {
            return HashicorpVaultSecretsService.get(vaultTemplate,
                    springCloudVaultKvBackend, springCloudVaultKvDefaultContext
        ...
        // Platform-specific secrets manager
            ...
            String repoToken = secretsService
                    .get(ONTOLOGY_SECRET_REPO_TOKEN_KEY + ontologyId);
            String repoWebhookSecret = secretsService
                    .get(ONTOLOGY_SECRET_REPO_WEBHOOK_SECRET_KEY + ontologyId);
            return new OntologySecretData(ontologyId, repoToken,
                    repoWebhookSecret);
        }
    ...
    public void delete(int ontologyId) throws Exception {
        ...
        // Platform-specific secrets manager
            ...
            secretsService.delete(ONTOLOGY_SECRET_REPO_TOKEN_KEY + ontologyId);
